...
<body class="w3-light-grey w3-content" style="max-width:1600px">
    ...
    <!-- Fork -->
    <a class="github-fork-ribbon" href="https://github.com/tygalive/Project-Browser" data-ribbon="<?= lang("Projects.site.fork") ?>" title="Fork me on GitHub" target=" _blank"><?= lang("Projects.site.fork") ?></a>
